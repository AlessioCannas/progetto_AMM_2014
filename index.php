				...
				$titolo = "'".$titolo."%' ";
                        ...
                        if ( isset($_POST['Progetto']) )
                        {
                            ...
                            echo "<h3>-Uso di Php/MySQL</h3> ";
                            	...
                            	echo "<h3>-Sistema di registrazione, recupero dell'input utente tramite Php e salvataggio su database con MySQL</h3> ";
    				echo "<h3>-Sistema di visualizzazione dei giochi per categoria, recuperati da database</h3> ";
    				echo "<h3>-Sistema di ricerca e di visualizzazione in base al nome e alla categoria</h3> ";
